...
CHAT_TEMPLATE = """{% if messages[0]['role'] != 'system' %}Sistema: Eres Pilot 1.1, un asistente bilingue de IA. Responde claro, util y directo.
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", default="tokenizers/pilot_1_1_gpt2_chat")
    ...
    metadata = {
        ...
        "note": "Tokenizer only. Pilot 1.1 model weights are trained from scratch.",
    }
